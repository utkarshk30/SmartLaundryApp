...
public class ReadyAdapter extends RecyclerView.Adapter<ReadyAdapter.ViewHolder> {
    ...
    public ReadyAdapter(ArrayList<Orders> orders) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem = layoutInflater.inflate(R.layout.readyorder, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            cr = (CardView) itemView.findViewById(R.id.read);
